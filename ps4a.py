    ...
    while len(hand) != 0:
        ...
        if word == '.':
            ...
            if isValidWord(word, hand, wordList)== False:
                ...
                print(str(word)+' earned '+ str(points) + ' points.' +'Total: '+str(totalpoints)+ ' points')
                print()
...
def playGame(wordList):
    ...
    while True:
        print()
        user_input = input('Enter n to deal a new hand, r to replay the last hand, or e to end a game: ')
        if user_input == 'e':
            break
        elif user_input == 'n':
